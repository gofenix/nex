defmodule Mix.Tasks.Nex.New do
  ...
  defp normalize_starter(nil), do: :basic
  defp normalize_starter("basic"), do: :basic
  defp normalize_starter("saas"), do: :saas

  defp normalize_starter(other) do
    Mix.raise("Unknown starter #{inspect(other)}. Available starters: basic, saas")
  end

  defp starter_label(:basic), do: ""
  defp starter_label(:saas), do: " (starter: saas)"

  defp skip_deps_install? do
    System.get_env("NEX_NEW_SKIP_DEPS") == "1"
  end

  defp success_message(name, :basic, true) do
    """
  ...
  defp success_message(name, :basic, false) do
    """
  ...
  defp success_message(name, :saas, true) do
    """
  ...
  defp success_message(name, :saas, false) do
    """
  ...
  defp create_project(path, assigns, starter) do
    # Create directories
  ...
  defp project_dirs(path, :basic) do
    [path, "#{path}/src", "#{path}/src/pages", "#{path}/src/api", "#{path}/src/components"]
  end

  defp project_dirs(path, :saas) do
    [
      path,
      "#{path}/db",
      "#{path}/src",
  ...
  defp project_files(assigns, :basic) do
    [
  ...
  defp project_files(assigns, :saas) do
    [
  ...
  defp saas_flash_component(a) do
    """
