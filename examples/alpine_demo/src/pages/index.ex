defmodule AlpineDemo.Pages.Index do
  use Nex
  import AlpineDemo.Components.Users.List
  import AlpineDemo.Components.Users.FormModal
  import AlpineDemo.Components.Profile.Settings
