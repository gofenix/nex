  ...
  def render(assigns) do
    ...
    <div class="py-8">
      <div class="container mx-auto max-w-4xl px-4">
        <!-- Back Link -->
        <div class="mb-6">
          <a href="/projects" class="link link-primary text-sm hover:underline">← Back to Projects</a>
        </div>
        ...
        <div class="card bg-base-100 border border-base-200 rounded-xl">
          <div class="card-body p-6">
            ...
            <div class="flex items-start gap-4 mb-4">
              {Avatar.render(%{name: @project["name"], size: "xl"})}
              <div class="flex-1">
                <div class="flex items-start justify-between">
                  <h1 class="text-2xl md:text-3xl font-bold text-base-content">{@project["name"]}</h1>
                  <div class="text-right shrink-0 ml-4">
                    <div class="text-accent font-bold text-xl">
                      {format_stars(@project["stars"] || 0)}☆
                    </div>
                    <div class="text-xs text-base-content/50">GitHub Stars</div>
                  </div>
                </div>
                <p class="text-base-content/60 text-base mt-2 leading-relaxed">
                  {@project["description"]}
                </p>
              </div>
            </div>
