defmodule BestofEx.Components.ProjectRow do
  ...
  def render(assigns) do
    ~H"""
    <div class="flex items-start gap-4 py-4 border-b border-base-200 last:border-b-0 hover:bg-base-50 transition-colors">
      <!-- Rank number (if shown) -->
      <div :if={assigns[:rank]} class="text-base-content/30 font-bold text-sm w-6 text-right shrink-0 pt-2">
        {@rank}
      </div>
