defmodule AgentConsole.Pages.Index do
  ...
  def render(assigns) do
    ~H"""
    <div data-testid="agent-console-page" class="flex h-screen">
      <!-- Sidebar -->
      ...
      <div class="flex-1 flex flex-col">
        ...
        <!-- Messages -->
        <div id="messages" data-testid="agent-console-messages" class="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        <div class="bg-white border-t p-4">
          <form id="chat-form" data-testid="agent-console-chat-form" class="flex gap-2">
            <input
              type="text"
              name="message"
              id="message-input"
