defmodule NexExamplesTestSupport.HTTP do
  alias NexExamplesTestSupport.{Config, CookieJar, HTML}

  @default_headers [{"user-agent", "nex-example-test"}]
  ...
  defp build_multipart(parts) do
    boundary = "nex-example-test-#{System.unique_integer([:positive])}"
